...
function AddNewStudent() {
  ...
  return (
<form onSubmit={handleSubmit} className="mx-10 mt-4 px-8 py-4 rounded bg-blueGrayLight"  enctype="application/json">
    <h1 className="text-white text-xl mb-8">Add New Student</h1>
